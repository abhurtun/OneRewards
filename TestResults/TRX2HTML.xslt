...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="details">
    ...
    <table style="width:700;border:1px solid black;font-family:Verdana; font-size:10pt;">
      ...
      <xsl:for-each select="//vs:Results/vs:TestResultAggregation">
                  ...
                  <td colspan="3">
                    <table style="width:700;border:1px solid black;font-family:Verdana; font-size:8pt;table-layout:fixed;">
                      ...
                      <tr>
                        ...
                        <td>
                          <pre style="word-wrap: break-word">
                            <xsl:value-of select="vs:Output/vs:TextMessages/vs:Message"/>
                          </pre>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td colspan="3">
                    <table style="width:700;border:1px solid black;font-family:Verdana; font-size:8pt;table-layout:fixed;">
                      ...
                      <xsl:for-each select="vs:Output/vs:TextMessages/vs:Message">
                        <tr>
                          <td width="10"></td>
                          <td>
                            <pre style="word-wrap: break-word">
